...
L["Clock"] = "Relógio"
L["Cooldown Style"] = "Estilo do Cooldown"
...
L["Border Scale"] = "Escala da borda"
L["Hide aura tooltip"] = "Ocultar tooltip da aura"
L["Private auras are controlled by Blizzard. Positioning and style are limited, and changes may be delayed until combat ends."] = "Auras privadas são controladas pela Blizzard. Posicionamento e estilo são limitados, e mudanças podem ser adiadas até o fim do combate."
L["Target Counter depends on visible enemy nameplates and can be inaccurate when nameplates are hidden or restricted."] = "Contador de Alvos depende de nameplates inimigos visíveis e pode ficar impreciso quando nameplates estão ocultos ou restritos."
L["Targeted spells may use restricted data in Midnight. Some updates can fall back to safer delayed paths."] = "Feitiços Direcionados podem usar dados restritos no Midnight. Algumas atualizações podem cair em caminhos mais seguros e atrasados."
